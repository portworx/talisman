...
type PersistentVolumeClaimOps interface {
	...
	// GetPersistentVolumeClaimsAdvancedSelector GetPersistentVolumeClaimsAdvancedSelectorreturns all PVCs in given namespace and that match the optional labelSelector of type metav1.LabelSelector
	GetPersistentVolumeClaimsAdvancedSelector(namespace string, labelSelector string) (*corev1.PersistentVolumeClaimList, error)
}
...
// GetPersistentVolumeClaimsAdvancedSelector returns all PVCs in the given namespace and that match the optional labelSelector of type metav1.LabelSelector
func (c *Client) GetPersistentVolumeClaimsAdvancedSelector(namespace string, labelSelector string) (*corev1.PersistentVolumeClaimList, error) {
	return c.getPVCsWithListOptions(namespace, metav1.ListOptions{
