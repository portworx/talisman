...
type NodeOps interface {
	...
	UpdateNodeStatus(n *corev1.Node) (*corev1.Node, error)
...
// UpdateNodeStatus updates given node's status
func (c *Client) UpdateNodeStatus(n *corev1.Node) (*corev1.Node, error) {
	if err := c.initClient(); err != nil {
		return nil, err
	}
	return c.kubernetes.CoreV1().Nodes().UpdateStatus(context.TODO(), n, metav1.UpdateOptions{})
}
