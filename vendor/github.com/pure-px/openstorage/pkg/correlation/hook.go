...
// i.e. /go/src/github.com/pure-px/openstorage/pkg/correlation
...
func getLocalPackage(dir string) string {
	...
	// From /go/src/github.com/pure-px/openstorage/pkg/correlation
	// Need this                             /openstorage/pkg/correlation
	// From /go/src/github.com/a/b/vendor/github.com/pure-px/openstorage/pkg/correlation
	// Need this                             					   /openstorage/pkg/correlation
