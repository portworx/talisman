//go:generate mockgen -package=mock -destination=mock/cluster.mock.go github.com/pure-px/openstorage/cluster Cluster
//go:generate mockgen -destination=cluster/mock/cluster_listener.mock.go -package=mock github.com/pure-px/openstorage/cluster ClusterListener
package cluster
...
import (
	...
	"github.com/pure-px/openstorage/objectstore"
	"github.com/pure-px/openstorage/osdconfig"
	"github.com/pure-px/openstorage/pkg/auth"
	"github.com/pure-px/openstorage/pkg/clusterdomain"
	"github.com/pure-px/openstorage/pkg/defrag"
	"github.com/pure-px/openstorage/pkg/diags"
	"github.com/pure-px/openstorage/pkg/job"
	"github.com/pure-px/openstorage/pkg/nodedrain"
	"github.com/pure-px/openstorage/pkg/schedule"
	sched "github.com/pure-px/openstorage/schedpolicy"
	"github.com/pure-px/openstorage/secrets"
)
...
var (
	...
	ErrNodePartialDecommissioned = errors.New("Node is partially decommissioned.")
