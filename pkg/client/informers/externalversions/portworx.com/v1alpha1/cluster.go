...
import (
	portworx_com_v1alpha1 "github.com/portworx/talisman/pkg/apis/portworx.com/v1alpha1"
	...
	v1alpha1 "github.com/portworx/talisman/pkg/client/listers/portworx.com/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.PortworxV1alpha1().Clusters(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PortworxV1alpha1().Clusters(namespace).Watch(options)
			},
		},
		&portworx_com_v1alpha1.Cluster{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *clusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&portworx_com_v1alpha1.Cluster{}, f.defaultInformer)
}
