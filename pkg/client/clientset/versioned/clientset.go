...
type Interface interface {
	...
	PortworxV1alpha1() portworxv1alpha1.PortworxV1alpha1Interface
	// Deprecated: please explicitly pick a version if possible.
	Portworx() portworxv1alpha1.PortworxV1alpha1Interface
}
...
type Clientset struct {
	*discovery.DiscoveryClient
	portworxV1alpha1 *portworxv1alpha1.PortworxV1alpha1Client
}
...
func NewForConfig(c *rest.Config) (*Clientset, error) {
	...
	var cs Clientset
	var err error
	cs.portworxV1alpha1, err = portworxv1alpha1.NewForConfig(&configShallowCopy)
	if err != nil {
		return nil, err
	}
...
func NewForConfigOrDie(c *rest.Config) *Clientset {
	var cs Clientset
	cs.portworxV1alpha1 = portworxv1alpha1.NewForConfigOrDie(c)
...
func New(c rest.Interface) *Clientset {
	var cs Clientset
	cs.portworxV1alpha1 = portworxv1alpha1.New(c)
