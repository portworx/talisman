...
type FakeClusters struct {
	Fake *FakePortworxV1alpha1
	ns   string
}

var clustersResource = schema.GroupVersionResource{Group: "portworx.com", Version: "v1alpha1", Resource: "clusters"}

var clustersKind = schema.GroupVersionKind{Group: "portworx.com", Version: "v1alpha1", Kind: "Cluster"}
