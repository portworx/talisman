...
var clustersResource = schema.GroupVersionResource{Group: "portworx.io", Version: "v1beta1", Resource: "clusters"}

var clustersKind = schema.GroupVersionKind{Group: "portworx.io", Version: "v1beta1", Kind: "Cluster"}
...
func (c *FakeClusters) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.Cluster, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(clustersResource, c.ns, name, types.MergePatchType, data, subresources...), &v1beta1.Cluster{})
